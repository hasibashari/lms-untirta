...
import { BookOpen, Users, ClipboardList, ArrowRight, TrendingUp } from 'lucide-react';
import { getMyCourses } from '../../services/dosen.service';

/**
 * TeacherDashboard
 * Halaman utama setelah login untuk dosen
 * Fokus: Overview/ringkasan kelas dan aktivitas
...
export default function Dashboard() {
  ...
  const totalMaterials = courses.reduce((acc, course) => acc + (course._count?.materials || 0), 0);
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-slate-200 opacity-60 cursor-not-allowed">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-slate-500">Tugas & Submission</h3>
