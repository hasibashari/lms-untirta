...
import { getMaterialDetail, getMaterials } from '../material.service';
import { getMyCourses } from '../../course/course.service';
...
const MaterialDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      {/* Main Content */}
      <main className={`flex-1 min-w-0 min-h-screen transition-all duration-300 ${sidebarCollapsed ? 'lg:ml-16' : 'lg:ml-80'
        }`}>
        {/* Top Navigation Bar */}
        ...
        <div className="px-6 lg:px-16 py-8 lg:py-12">
          <div className="max-w-4xl mx-auto w-full">
            ...
            <article className="bg-white rounded-2xl border border-slate-200 p-8 lg:p-12 shadow-sm text-justify">
              {/* 
            ...
            */}
            ...
            {material.attachments && material.attachments.length > 0 && (
              <section className="mt-8 bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
